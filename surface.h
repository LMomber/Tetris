...
public:
	...
	void Print(const int a_Num, int x1, int y1, Pixel color, int width);
	//void Print(int points, int x1, int y1, Pixel color, int width = 1);
...
public:
	...
	void DrawScaled( int a_X, int a_Y, int a_Width, int a_Height, Surface* a_Target, unsigned int a_Index );
